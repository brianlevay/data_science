...
class Team():
    ...
    # need to return the instance, not the string!
    @classmethod
...
sorted_teams = sorted(teams, key=lambda x: x.average_age())

print(oldest_team.team_name)
print(youngest_team.team_name)
for team in sorted_teams:
    print("Name: {0}, Age: {1}".format(team.team_name, team.average_age()))